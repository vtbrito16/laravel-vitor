...
<h4 class="mb-0"><i class="fas fa-folder-plus mr-2"></i> Atualizar tegoria</h4>
...
<input type="text" name="nome" id="nome" class="form-control @error('nome') is-invalid @enderror" placeholder="Digite o nome da categoria" value="{{ old('nome',  $categoria->nome)}}">
@error('nome')
